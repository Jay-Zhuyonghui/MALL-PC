...
getData('https://www.fastmock.site/mock/3401869bd4dfa913f24d163f4f6ddc9d/api/slider').then((data)=>{
 document.querySelector('.carousel').innerHTML=render({
  items:data
 });
}).then(()=>{
  /* 轮播图特效
